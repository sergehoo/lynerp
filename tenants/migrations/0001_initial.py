    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tax_center', models.CharField(blank=True, max_length=128)),
                ...
                ('billing_region', models.CharField(blank=True, max_length=80)),
                ('billing_country', models.CharField(blank=True, default="Côte d'Ivoire", max_length=80)),
                ...
                ('stamp_url', models.CharField(blank=True, max_length=255)),
                ...
                ('mobile_money_details', models.JSONField(blank=True, default=dict)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('HR_BPO', 'RH Externalisée'), ('OWNER', 'Propriétaire'), ('ADMIN', 'Administrateur'), ('MANAGER', 'Manager'), ('MEMBER', 'Membre'), ('VIEWER', 'Observateur')], default='MEMBER', max_length=20)),
